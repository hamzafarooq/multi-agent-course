...
The [LUMINA spec, section 13](modules/Module_1_Agent_Foundations_Harness_System_Design/Assignment_1_Lumina/SPEC.md#13--quality-bar-how-done-is-proven) is the worked example: the declared `expectations.json`, the run-log shape, the six gates, and the rubric rows mapped to rule IDs.
